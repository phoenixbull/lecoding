...
tasks, and two performance tasks. Both attempts used fresh Git fixtures and the
...
| Task | Category | Attempt 1 | Attempt 2 |
| --- | --- | --- | --- |
| `ts-fix-boundary` | bugfix | protocol failure | passed |
| `js-fix-async-race` | bugfix | passed | passed |
| `python-fix-parser` | bugfix | passed | passed |
| `ts-add-required-field` | feature | passed | passed |
| `python-add-validation` | feature | passed | passed |
| `ui-empty-state` | feature | passed | passed |
| `security-path-traversal` | security | passed | passed |
| `schema-unique-call-id` | security | passed | passed |
| `docs-quickstart` | docs | passed | passed |
| `docs-error-reference` | docs | passed | protocol failure |
| `performance-deduplicate` | performance | passed | passed |
| `performance-bounded-log` | performance | protocol failure | passed |

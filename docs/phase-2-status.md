...
- Current focused approval/policy/API/SDK/Web suite: 102/102 tests passed across
...
- Non-Docker repository suite: 286 tests passed and one opt-in live-model test
  was skipped; HTTP transport passed 8/8 with loopback-bind permission.
- Raw repository suite: 291 tests passed and one opt-in live-model test was
